Report 50000 "Check (Check/Stub/Stub)2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AL Code/Report/RDLC/Rep10412-CheckCheckStubStub.rdlc';
    Caption = 'Check (Check/Stub/Stub) kop';
    ...
    var
        ...
        USText002Err: label 'Process canceled at user request.';
